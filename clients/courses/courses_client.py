...
from clients.courses.courses_schema import GetCursesQuerySchema, CreateCourseRequestSchema, UpdateCourseRequestSchema, \
...
class CoursesClient(APIClient):
    ...
    def get_courses_api(self, query: GetCursesQuerySchema) -> Response:
        """
