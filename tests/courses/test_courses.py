...
from clients.courses.courses_schema import UpdateCourseRequestSchema, UpdateCourseResponseSchema, GetCursesQuerySchema, \
...
class TestCourses:
    ...
    def test_get_courses(
        ...
        query = GetCursesQuerySchema(userId=function_user.response.user.id)
